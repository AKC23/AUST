...
subplot(2, 4, 4);imshow(out4);title('Figure (d)');
...
subplot(2, 4, 5);imshow(out5);title('Figure (e)');

% Step 6: Get the product of (c) and (e)
out6 = out3 .* out5;

subplot(2, 4, 6);imshow(out6);title('Figure (f)');

% Step 7: Add (a) and (f)
out7= I + out6;

subplot(2, 4, 7);imshow(out7);title('Figure (g)');
...
subplot(2, 4, 8);imshow(out8);title('Figure (h)');
