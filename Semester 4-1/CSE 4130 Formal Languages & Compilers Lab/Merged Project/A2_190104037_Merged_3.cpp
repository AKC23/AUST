...
string result;
vector<string> sym_arr, syntactic;
...
string only_identifiers(string str)
{
    string str5 = str;
    string substring;
    //Of all the lexemes only identifiers are kept in pairs for formation, erase others 
...
int main()
{
    ...
    else
    {
        ...
        //Assignment 01: Remove the comments and white space (extra spaces, tabs and newline characters).
        cout << "\nStep 1: After removing comments and white space\n";
        cout << str5 << "\n";
        ...
        str5 = parse(char_str);
        cout<<"Step 2: Lexemes are categorized under the categories:\n"<<str5;
        ...
        str5 = modified_token_stream(str5);
        cout<< str5;
    }
