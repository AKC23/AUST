...
SCL 	DB  41h, 22h, 14h, 08h, 7Fh, 7Eh, 09h, 09h ,09h, 7Eh, 41h, 41h, 7Fh, 41h, 41h, 32h, 49h, 49h, 49h, 26h, 41h, 41h, 7Fh, 41h, 41h, 7Eh, 09h, 09h ,09h, 7Eh, 7Fh, 02h, 04h, 02h, 7Fh, 01h, 01h, 7Fh, 01h,01h
...
SCROLL1: 
    ...
    JBE P_SSD
    CMP SI,7
    JA P_DOT  ;IF SI GRATER THAN 7 THEN ONLY SCROLL
